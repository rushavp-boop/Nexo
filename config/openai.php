...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | SSL verification for HTTPS requests. Set to false for development on Windows
    | where CA bundle might not be configured. Not recommended for production.
    */

    'verify' => env('OPENAI_VERIFY_SSL', false),
];
